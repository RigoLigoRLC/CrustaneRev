...
| CRUSTANEREV_S3_ACCESS_KEY    | Access key for S3 bucket. S3 is used because if you need to upload image from bot then you'd have to let Tencent download it from an URL. Thus a storage service is needed and I chose to use S3.                                                                                    |
| CRUSTANEREV_S3_ENDPOINT_URL  | The S3 endpoint URL.                                                                                                                                                                                                                                                                 |
| CRUSTANEREV_S3_SECRET_KEY    |                                                                                                                                                                                                                                                                                      |
| CRUSTANEREV_S3_BUCKET_PREFIX |                                                                                                                                                                                                                                                                                      |
